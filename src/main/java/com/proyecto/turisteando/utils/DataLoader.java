    ...
    public void run(String... args) throws Exception {
        ...
        if (categories.isEmpty()) {
            categoryRepository.saveAll(Arrays.asList(
                    CategoryEntity.builder().name("Tours").status((byte) 1).description("Recorridos turísticos...").image("https://example.com/images/tours.jpg").build(),
                    CategoryEntity.builder().name("Actividades").status((byte) 1).description("Actividades al aire libre...").image("https://example.com/images/activities.jpg").build()
            ));
        }
